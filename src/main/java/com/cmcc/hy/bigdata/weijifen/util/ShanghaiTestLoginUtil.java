...
public class ShanghaiTestLoginUtil {
    ...
    public static Configuration getConf(Configuration conf) {
        ...
        LOG.info(
                "zookeeper.sasl.clientconfig:" + System.getProperty("zookeeper.sasl.clientconfig"));
    ...
    public static void setJaasConf(String loginContextName, String principal, String keytabFile) {
        JaasConfiguration conf = new JaasConfiguration(loginContextName, principal, keytabFile);
