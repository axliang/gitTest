...
public class ConfigurationUtil {
     ...
     * 
     * @param args 参数
     * @param specificFileName 指定配置文件
     * @param conf 默认配置
     * @return 返回配置信息
     */
    public static Configuration loginAuthentication(String[] args, String specificFileName,
                                                    Configuration conf) {
        if (args.length < 1) {
    ...
    private static Configuration choose(String loginWay, String configPath,
